...
function Detail() {
    ...
    return (
        ...
        <div>
        {/* <div style={{ color: 'white', border: '1px solid black', margin: '20px', height: '100%', padding: '20px', backgroundColor: 'deeppink', width: '100%', textAlign: 'center' }}>
        ...
        <div style={{ color: 'deeppink' }}>
            ...
            {details.menu.map(item => {
                return <div style={{ display: "inline-block", width: '29%', border: '1px solid black', margin: '20px', height: '100%', padding: '5px', backgroundColor: 'white', textAlign: 'center' }}>
                    <h2 >{item.item}</h2>
                    <h2 >Rs.{item.price}</h2>
                    <button style={{ backgroundColor: 'deeppink', padding: '10px', borderRadius: '10px', color: 'white', margin: '30px', border: '1px solid deeppink' }} onClick={() => navigate('/cart')}>Add to cart</button>
                </div>

            })}
        </div>

        <div style={{ border: '1px solid black', margin: '10px', height: '100%', padding: '10px', backgroundColor: 'deeppink', width: '100%', textAlign: 'center', display: 'flex', color: 'white' }}>
